...
# since there were so many SRP sites, reduce number by filtering where nflowdays is less than 20:

df.NWIS.SRP_sites<-df.NWIS.SRP_sites%>%filter(nflowdays>20)
...
# filter the gauges2 to the NYS SRP CQ sites:
