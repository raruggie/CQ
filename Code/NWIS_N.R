...
df.NWIS.TN_sites<-fun.df.Pair_consit_flow('00600', df.NWIS.Q_sites, n_samples = 20, state = 'NY')
...
df.NWIS.TN<-readNWISqw(siteNumbers = df.NWIS.TN_sites$site_no, parameterCd = '00600')
...
# how many of these TN sites overlap with the top 40 TP sites?
# cause maybe I dont need to delineate all of them:

load('Processed_Data/Top_40_TP_sites.Rdata')

x<-filter(TN_sites, site_no %in% m$site_no)
