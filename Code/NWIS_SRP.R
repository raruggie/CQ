...
temp1<-df.NWIS.SRP_CQ%>%filter(sample_dt >= 2001)
...
p1 # running this with the 12 sites for SRP is not resulting in signfincant pvalues even though spearman correlaitons are -0.5!
